...
| **NEARING_TURN** | Patient is exactly N slots ahead of their turn (SMS once per reservation; N from that branch’s `systemConfiguration/{branchId}/sms/nearingTurnAheadCount`, default 3). | Queue Engine Recalculation | Specific Parent |
