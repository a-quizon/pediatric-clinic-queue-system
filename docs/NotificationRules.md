...
| **RESERVATION_CANCELLED_BY_CLINIC** | The clinic closed the reserved day. The parent rebooks on another posted day. | Secretary or doctor closes that date while the reservation is still `reserved` or `waiting`. | Specific Parent |
