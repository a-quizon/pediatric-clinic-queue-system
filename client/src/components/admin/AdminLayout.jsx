  ...
  return (
    <div className="pq-shell flex h-screen md:flex-row flex-col overflow-hidden">
      <aside className="hidden md:flex flex-col w-64 pq-glass-nav z-20 flex-shrink-0 rounded-none border-y-0 border-l-0">
        ...
        <nav className="flex-1 py-6 px-4 space-y-1.5 overflow-y-auto pq-scroll-y" aria-label="Admin">
          {renderNavLinks()}
        </nav>
      ...
      <main className="flex-1 overflow-y-auto pq-scroll-y w-full h-full relative flex flex-col bg-transparent">
