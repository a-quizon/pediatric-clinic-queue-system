...
export const TOUR_STEPS = [
  {
    ...
    description: "After you book, Home shows your queue number, patients ahead, and who is with the doctor.",
  },
  {
    id: "parent-book",
    route: "/parent",
  ...
  },
  {
    ...
    description: "Choose a session, then select the child and add the visit concern.",
  ...
  },
  {
    ...
    title: "Tickets and details",
    description: "Your tickets, visit concern, and QR check-in code live here.",
  },
  {
